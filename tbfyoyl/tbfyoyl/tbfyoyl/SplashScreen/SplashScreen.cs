...
namespace tbfyoyl
{
    public class SplashScreen : Minigame
    {
            ...
            : base(game)
        {
            ...
            menuItems[0] = new MenuObject(new DrawableObject(MediaManager.textures["BLAH"], new Vector2(0, 0)),
                delegate()
                {
                    game.ActiveGame = "WORLDMAP";
                });
            menuItems[1] = new MenuObject(new DrawableObject(MediaManager.textures["BLAH"], new Vector2(100, 0)),
                delegate()
                {
                    game.Exit();
                });
